...
func (h *FavoriteHandler) AddFavorite(c *gin.Context) {
	...
	common.RespondJSON(c, http.StatusCreated, fav)
}
...
func (h *FavoriteHandler) RemoveFavorite(c *gin.Context) {
	...
	targetID, err := common.ParseUUIDParam(c, "id")
	if err != nil {
	...
	common.RespondJSON(c, http.StatusOK, gin.H{"message": "removed"})
}
...
func (h *FavoriteHandler) ListFavorites(c *gin.Context) {
	...
	common.RespondJSON(c, http.StatusOK, favorites)
}
...
func (h *FavoriteHandler) CheckFavorite(c *gin.Context) {
	...
	common.RespondJSON(c, http.StatusOK, gin.H{"is_favorite": isFav})
}
