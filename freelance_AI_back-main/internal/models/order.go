...
type Proposal struct {
	...
	ProposedBudget        *float64   `db:"proposed_budget" json:"proposed_budget,omitempty"`
	EstimatedDays         *int       `db:"estimated_days" json:"estimated_days,omitempty"`
	Status                string     `db:"status" json:"status"`
	AIFeedback            *string    `db:"ai_feedback" json:"ai_feedback,omitempty"`
	AIAnalysisForClient   *string    `db:"ai_analysis_for_client" json:"ai_analysis_for_client,omitempty"`
	AIAnalysisForClientAt *time.Time `db:"ai_analysis_for_client_at" json:"ai_analysis_for_client_at,omitempty"`
	CreatedAt             time.Time  `db:"created_at" json:"created_at"`
	UpdatedAt             time.Time  `db:"updated_at" json:"updated_at"`
}
