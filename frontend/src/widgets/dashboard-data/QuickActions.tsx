...
const CLIENT_ACTIONS: QuickAction[] = [
    { label: "Создать заказ", description: "Новая задача на маркетплейс", icon: <Plus size={20} />, href: "/dashboard/orders/new", primary: true, iconBg: "bg-purple-500/15", iconColor: "text-purple-400" },
    ...
    { label: "Профиль", description: "Настройки аккаунта", icon: <User size={20} />, href: "/dashboard/profile", iconBg: "bg-indigo-500/15", iconColor: "text-indigo-400" },
...
const FREELANCER_ACTIONS: QuickAction[] = [
    { label: "Найти заказы", description: "Обзор маркетплейса", icon: <Search size={20} />, href: "/dashboard/orders", primary: true, iconBg: "bg-purple-500/15", iconColor: "text-purple-400" },
                ...
                {actions.map((action, i) => (
                    <Link
                        ...
                        className={`flex flex-col items-center gap-3 p-4 rounded-xl border transition-all duration-200 text-center group animate-fade-in-up ${
                            action.primary
                                ? "bg-purple-600/10 border-purple-500/20 hover:bg-purple-600/15 hover:border-purple-500/30"
